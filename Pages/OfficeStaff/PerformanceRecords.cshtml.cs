...
namespace TM_PE.Pages.OfficeStaff
{
    ...
    // employee: their own evaluation history and appraisal feedback trail.
    // Mirrors Manager/AppraisalRecords/Details, scoped to the current
    // session's employee instead of an {id} route param, and with nothing to
    // edit - an employee can only ever view their own record here.
